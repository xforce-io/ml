...
class GeneralConfig:
    ...
    DEVICE = "mps" if torch.backends.mps.is_available() else "cpu" # 自动检测 MPS
...
class DqnConfig:
    ...
    LEARNING_RATE = 1e-4        # 增加学习率，加速学习
    GAMMA = 0.99
    BATCH_SIZE = 128               # 增大批次大小，使梯度更稳定
    ...
    LEARNING_STARTS = 10000         # 开始学习的步数，减少以便快速启动学习
